        ...
        <div className="innerwidth">
          <div className="innercontainer">
            ...
            <div class="row"><div class="col-sm">
              ...
              <p>
                Paikkatietokanta on <a href="http://penttinen.fi/">Jani Penttisen</a> päättöprojektina syntynyt sivusto. Paikkatietokannan tarkoitus on yhdistää valokuvaharrastus, historiallinen dokumentointi ja ammatillinen focus kehittyä paremmaksi koodariksi.</p>

              <p>Sivusto on rakennettu käyttämällä: <br />
                <code>HTML5, SASS, MySQL, React, Node</code> ja palju <code>kohvi.</code>
              </p>
              <a href="https://github.com/dommend/paikkatietokanta" style={{ margin: '40px 0px', padding: '25px' }} className="btn btn-outline-info btn-block">
